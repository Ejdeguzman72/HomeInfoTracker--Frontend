                ...
                <div id="hero-add-repair-shop-information-background">
                    ...
                    <Container className="update-doctor-office-information-container">
                        <Form>
                            ...
                            <input type="number" className="medical-record-input" onChange={(event: any) => this.handleMedicalRecordIdChange(event)} />
                            <hr></hr>
                            ...
                            <input type="text" className="medical-record-input" value={this.state.doctorName} onChange={(event: any) => this.handleDoctorNameChange(event)} />
                            <br></br>
                            <label>
                                Description:
                            </label>
